/*
 * heatflux3n_emxutil.h
 *
 * Code generation for function 'heatflux3n_emxutil'
 *
 */

#ifndef __HEATFLUX3N_EMXUTIL_H__
#define __HEATFLUX3N_EMXUTIL_H__
...
/* End of code generation (heatflux3n_emxutil.h) */

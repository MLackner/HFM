START_DIR = /Users/lackner/Documents/MATLAB/HeatFlowModel

MATLAB_ROOT = /Applications/MATLAB_R2014b.app
MAKEFILE = heatflux3n_mex.mk

include heatflux3n_mex.mki
...
SRC_FILES =  \
	...
	heatflux3n_emxutil.c \
	_coder_heatflux3n_mex.c \
	_coder_heatflux3n_info.c

MEX_FILE_NAME_WO_EXT = heatflux3n_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/heatflux3n"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/heatflux3n/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/heatflux3n/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/heatflux3n/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/heatflux3n/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
